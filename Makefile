...
deployLazy:
	@forge script script/lazyDeploy.s.sol:lazyDeploy $(NETWORK_ARGS)

deployReward:
	@forge script script/rewardDeploy.s.sol:rewardDeploy $(NETWORK_ARGS)

deployStaker:
	@forge script script/stakerDeploy.s.sol:stakerDeploy $(NETWORK_ARGS)
...
# the zksync part is not working need to work on that 
# zkdeploy: 
